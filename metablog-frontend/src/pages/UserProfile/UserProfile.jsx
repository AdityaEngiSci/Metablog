        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="max-w-xl mx-auto p-5 relative">
                ...
                <div className="text-center mb-8">
                    <img src={profileImageUrl} alt="Profile" className="w-32 h-32 rounded-full mx-auto mb-2" />
                    <label htmlFor="profileImage" className="text-blue-500 cursor-pointer">Change profile photo</label>
                    <input
                        type="file"
                        id="profileImage"
                        accept="image/*"
                ...
                <form onSubmit={handleProfileUpdate} className={`space-y-4 ${isEditingPassword ? 'blur-background' : ''}`}>
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                            ...
                            <label className="block mb-3 relative">
                                ...
                                />
                                <button type="button" onClick={toggleNewPasswordVisibility} className="absolute inset-y-0 right-0 px-3 py-2 text-gray-500">
                            ...
                            <div className="flex justify-end mt-4">
                                <button onClick={handlePasswordSave} className="px-4 py-2 bg-black text-white rounded-md mr-2">Save</button>
                                <button onClick={handlePasswordCancel} className="px-4 py-2 bg-gray-200 text-gray-800 rounded-md">Cancel</button>
                            </div>
                        </div>
                    </div>
                )}
